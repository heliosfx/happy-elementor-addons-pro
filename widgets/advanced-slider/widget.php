    ...
    protected function __arrow_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.ha-arrow-sync-no .ha-slider-prev, {{WRAPPER}}.ha-arrow-sync-no .ha-slider-next' => 'top: {{SIZE}}{{UNIT}};transform: translateY(-50%);',
                    '{{WRAPPER}}.ha-arrow-sync-yes .ha-slider-prev, {{WRAPPER}}.ha-arrow-sync-yes .ha-slider-next' => 'top: {{SIZE}}{{UNIT}};transform: translateY(-50%);',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.ha-arrow-sync-no .ha-slider-prev' => 'left: {{SIZE}}{{UNIT}}; right: auto;',
                    '{{WRAPPER}}.ha-arrow-sync-no .ha-slider-next' => 'right: {{SIZE}}{{UNIT}}; left: auto;',
                    '{{WRAPPER}}.ha-arrow-sync-yes .ha-slider-prev, {{WRAPPER}}.ha-arrow-sync-yes .ha-slider-next' => 'left: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.ha-arrow-sync-yes .ha-slider-next' => 'margin-left: calc({{SIZE}}{{UNIT}}/ 2);',
                    '{{WRAPPER}}.ha-arrow-sync-yes .ha-slider-prev' => 'margin-right: calc({{SIZE}}{{UNIT}}/ 2);',
                ],
            ]
        );
    ...
    protected function __pagination_progressbar_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ha-slider-pagination.swiper-pagination-progressbar' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function __scroll_bar_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ha-slider-scrollbar.swiper-scrollbar' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
...
?>
        <div class="ha-slider-widget-wrapper ha-unique-widget-id-<?php echo esc_attr($this->get_id()); ?>">
