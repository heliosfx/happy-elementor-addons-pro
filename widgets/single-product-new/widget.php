...
class Single_Product_New extends Base {
    ...
    public function render_classic__old($settings) {
    ...
    public function render_landscape__old($settings) {
    ...
    public function render_standard__old($settings) {
