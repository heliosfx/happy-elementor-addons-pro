...
?>
            <div class="ha-editor-placeholder">
                ...
                <div class="ha-editor-placeholder-content">
                    <?php esc_html_e('This placeholder text doesn\'t serve any purpose. It won\'t show up in the frontend either. Go to preview mood to see full functionalities.', 'happy-addons-pro'); ?>
                </div>
            </div>
        <?php endif; ?>
